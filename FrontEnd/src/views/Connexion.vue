  ...
  <div>
    ...
    <div class="sidenav">
      <div class="login-main-text">
        <h2>Page de Conexion<br />de l&apos;application</h2>
      ...
      <div class="col-md-6 col-sm-12">
        <div class="login-form">
          <form @submit.prevent="handleLogin">
            ...
            <label
              >Si vous n'avez pas de compte inscrivez vous avec le bouton en
              dessous</label
            >
            <router-link class="nav-link ml-auto btn btn-dark" to="/Inscrire"
    ...
    handleLogin() {
      ...
      auth
        ...
        .then((response) => {
          ...
          if(localStorage.token){this.$router.push("/Cours");}
